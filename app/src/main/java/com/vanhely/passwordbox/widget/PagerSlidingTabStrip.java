...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
		...
		//下面4个扩展的属性
		tabTextSize=a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_setTabTextSize, tabTextSize);
		tabTextColor=a.getColor(R.styleable.PagerSlidingTabStrip_setTabTextColor, tabTextColor);
		selectedTabTextSize=a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_setSelectedTabTextSize, selectedTabTextSize);
		selectedTabTextColor=a.getColor(R.styleable.PagerSlidingTabStrip_setSelectedTabTextColor, indicatorColor);
